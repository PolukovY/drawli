...
const paths: Record<IconName, React.ReactNode> = {
  ...
  camera: <><path d="M4 8.5A2 2 0 016 6.5h2.2l1-1.6a1 1 0 01.85-.5h4a1 1 0 01.85.5l1 1.6H18a2 2 0 012 2V17a2 2 0 01-2 2H6a2 2 0 01-2-2z" /><circle cx="12" cy="12.5" r="3.4" /></>,
